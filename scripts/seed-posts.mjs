...
const POSTS_BY_USER = {
  '田中太郎': [
    ...
    },
    {
      ...
      genre: 'ラーメン',
      price_range: '¥1,001〜¥3,000',
      location_name: 'らーめん 二代目武蔵 池袋店',
      location_lat: 35.7295,
      location_lng: 139.7109,
    ...
    },
    {
      ...
      genre: '中華',
      price_range: '〜¥1,000',
      location_name: '老舗中華 龍鳳 上野店',
      location_lat: 35.7126,
      location_lng: 139.7744,
    ...
    },
    {
      ...
      genre: 'ラーメン',
      price_range: '¥1,001〜¥3,000',
      location_name: 'つけ麺 大勝軒 六本木',
      location_lat: 35.6641,
      location_lng: 139.7322,
  ...
  '佐藤花子': [
    {
      ...
      genre: 'スイーツ',
      price_range: '〜¥1,000',
      location_name: 'Fruit Sandwich 青山',
      location_lat: 35.6663,
      location_lng: 139.7130,
    ...
    },
    {
      ...
      genre: 'カフェ',
      price_range: '¥1,001〜¥3,000',
      location_name: 'Café Daikanyama',
      location_lat: 35.6488,
      location_lng: 139.7031,
    ...
    },
    {
      ...
      genre: 'スイーツ',
      price_range: '¥1,001〜¥3,000',
      location_name: 'Patisserie Aoyama',
      location_lat: 35.6654,
      location_lng: 139.7122,
    ...
    },
    {
      ...
      genre: 'カフェ',
      price_range: '〜¥1,000',
      location_name: 'Retro Café 吉祥寺',
      location_lat: 35.7027,
      location_lng: 139.5786,
    ...
    },
    {
      ...
      location_name: 'The Garden Restaurant 渋谷',
      location_lat: 35.6612,
  ...
  '鈴木健二': [
    {
      ...
      genre: '洋食',
      price_range: '〜¥1,000',
      location_name: '洋食 キッチン神田',
      location_lat: 35.6941,
      location_lng: 139.7713,
    ...
    },
    {
      ...
      location_name: '黒毛和牛 炭火焼肉 恵比寿',
      location_lat: 35.6466,
      location_lng: 139.7132,
    ...
    },
    {
      ...
      genre: '洋食',
      price_range: '¥10,001〜',
      location_name: 'Teppanyaki ROKU 六本木',
  ...
  '伊藤由紀': [
    ...
    },
    {
      ...
      genre: '寿司',
      price_range: '¥5,001〜¥10,000',
      location_name: '鮨 吉田 新宿',
      location_lat: 35.6938,
      location_lng: 139.6982,
    ...
    },
    {
      ...
      genre: '和食',
      price_range: '¥10,001〜',
      location_name: '懐石 花梨 神楽坂',
      location_lat: 35.7002,
      location_lng: 139.7425,
    ...
    },
    {
      ...
      genre: '寿司',
      price_range: '¥3,001〜¥5,000',
      location_name: '海鮮丼 つきじ 佐藤',
      location_lat: 35.6655,
      location_lng: 139.7701,
  ...
  '山田翔太': [
    {
      ...
      genre: '韓国料理',
      price_range: '¥3,001〜¥5,000',
      location_name: '韓国家庭料理 ハンウル 新大久保',
      location_lat: 35.7011,
      location_lng: 139.7001,
    ...
    },
    {
      ...
      genre: 'アジア料理',
      price_range: '¥1,001〜¥3,000',
      location_name: 'Thai Kitchen Baan 高田馬場',
    ...
    },
    {
      ...
      genre: 'アジア料理',
      price_range: '〜¥1,000',
      location_name: '台湾まぜそば 麺や虎鉄 神田',
      location_lat: 35.6940,
      location_lng: 139.7720,
  ...
  'demo_ebi': [
    ...
    },
    {
      ...
      genre: 'カフェ',
      price_range: '¥1,001〜¥3,000',
      location_name: 'River Side Café 中目黒',
    ...
    },
    {
      ...
      genre: 'フレンチ',
      price_range: '¥1,001〜¥3,000',
      location_name: 'Boulangerie Daikanyama',
      location_lat: 35.6492,
