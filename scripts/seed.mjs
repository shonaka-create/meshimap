...
const ALL_USERS = [
  {
    ...
    email: emailFor('taro'),
    displayName: '田中太郎',
    // 東京のラーメンだけではなくなったので、bio も合わせる。
    // プロフィールと投稿がずれていると、それだけで作り物に見える。
    bio: '東京と大阪で、個人店だけを歩いています。ラーメンから鮨まで。看板の小さい店が好き',
...
const POSTS_BY_USER = {
  taro: [
    ...
    /* ── 東京・ラーメン以外 ────────────────────────
     * 地図をラーメンだけで埋めると、ジャンル絞り込みも
     * エリアの広がりも動かして確かめられない。
     */
    {
      caption: '神田の路地裏、カウンター8席の蕎麦屋。昼は蕎麦、夜は肴を出す二毛作。鴨せいろの汁が濃すぎず、蕎麦の香りを消さない。仕事の合間に一人で行く店として完璧だった',
      rating: 5,
      genre: '和食',
      price_range: '¥1,001〜¥3,000',
      location_name: '蕎麦 むぎとり',
      location_lat: 35.6922,
      location_lng: 139.7695,
      prefecture: '東京都',
      area: '神田',
      situations: ['一人ランチにおすすめ', '仕事で'],
      hashtags: ['蕎麦', '神田', '二毛作', '個人店'],
      images: ['https://images.unsplash.com/photo-1618841557871-b4664fbf0cb3?w=800&q=90'],
      daysAgo: 3,
    },
    {
      caption: '清澄白河の焙煎所。浅煎りのエチオピアを一杯ずつ淹れてくれる。豆の説明が押しつけがましくないのがいい。倉庫を改装した天井の高さと、川沿いの静けさで長居してしまう',
      rating: 4,
      genre: 'カフェ',
      price_range: '〜¥1,000',
      location_name: 'クラマ珈琲焙煎所',
      location_lat: 35.6822,
      location_lng: 139.8003,
      prefecture: '東京都',
      area: '清澄白河',
      situations: ['一人ランチにおすすめ', '隠れ家'],
      hashtags: ['コーヒー', '清澄白河', '焙煎所', '浅煎り'],
      images: ['https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=800&q=90'],
      daysAgo: 5,
    },
    {
      caption: '西麻布の坂の下、看板を出していない鮨。おまかせ一本で、握りの合間に酒肴が挟まる構成。赤酢のシャリが少し温かくて、いい塩梅だった。記念日に連れて行きたい店',
      rating: 5,
      genre: '寿司',
      price_range: '¥10,001〜',
      location_name: '鮨 とわ',
      location_lat: 35.6598,
      location_lng: 139.7255,
      prefecture: '東京都',
      // 西麻布は内蔵データに無い。座標から判定すると六本木になるので、
      // 表示と集計がずれないよう宣言もそちらに合わせる。
      area: '六本木',
      situations: ['記念日', 'デート', '隠れ家'],
      hashtags: ['寿司', '西麻布', 'おまかせ', '赤酢'],
      images: ['https://images.unsplash.com/photo-1583623025817-d180a2221d0a?w=800&q=90'],
      daysAgo: 8,
    },
    {
      caption: '門前仲町の焼き鳥。備長炭で、塩は岩塩を挽いたもの。レバーの火入れが絶妙で、これだけ追加した。10席のカウンターに常連が並んでいて、店の空気ごと美味い',
      rating: 5,
      genre: '和食',
      price_range: '¥3,001〜¥5,000',
      location_name: '焼鳥 山彦',
      location_lat: 35.6723,
      location_lng: 139.7974,
      prefecture: '東京都',
      area: '門前仲町',
      situations: ['飲み会', '一人ランチにおすすめ'],
      hashtags: ['焼き鳥', '門前仲町', '備長炭'],
      images: ['https://images.unsplash.com/photo-1519690889869-e705e59f72e1?w=800&q=90'],
      daysAgo: 15,
    },
    {
      caption: '下北沢のイタリアン。ワインが安くて、パスタが本気。ゴルゴンゾーラのニョッキが忘れられない。二人でやっている小さな店で、予約は電話だけというのも含めて好き',
      rating: 4,
      genre: 'イタリアン',
      price_range: '¥3,001〜¥5,000',
      location_name: 'トラットリア チェルキオ',
      location_lat: 35.6608,
      location_lng: 139.6667,
      prefecture: '東京都',
      area: '下北沢',
      situations: ['デート', '飲み会'],
      hashtags: ['イタリアン', '下北沢', 'ワイン', 'ニョッキ'],
      images: ['https://images.unsplash.com/photo-1551183053-bf91a1d81141?w=800&q=90'],
      daysAgo: 20,
    },

    /* ── 大阪 ─────────────────────────────────
     * 東京だけだと、都道府県をまたぐ移動の演出も
     * エリアの集計も確かめられない。
     */
    {
      caption: '大阪出張のたびに寄る福島の立ち飲み。造りが驚くほど良くて、値段を二度見した。カウンターだけで、隣の人と自然に話が始まる。東京にはこの距離感の店が少ない',
      rating: 5,
      genre: '和食',
      price_range: '¥1,001〜¥3,000',
      location_name: '立呑み 万作',
      location_lat: 34.6949,
      location_lng: 135.4867,
      prefecture: '大阪府',
      area: '福島',
      situations: ['飲み会', '一人ランチにおすすめ'],
      hashtags: ['立ち飲み', '福島', '大阪', '刺身'],
      images: ['https://images.unsplash.com/photo-1580442151529-343f2f6e0e27?w=800&q=90'],
      daysAgo: 6,
    },
    {
      caption: '難波のうどん。出汁が澄んでいて、最後まで飲める。かしわ天が揚げたてで出てくるのが嬉しい。関西の出汁はやっぱり違うと毎回思わされる一杯',
      rating: 5,
      genre: '和食',
      price_range: '〜¥1,000',
      location_name: 'うどん 千歳屋',
      location_lat: 34.6669,
      location_lng: 135.5021,
      prefecture: '大阪府',
      area: '難波・心斎橋',
      situations: ['一人ランチにおすすめ', 'ランチにおすすめ'],
      hashtags: ['うどん', '難波', '大阪', '出汁'],
      images: ['https://images.unsplash.com/photo-1618841557871-b4664fbf0cb3?w=800&q=90'],
      daysAgo: 9,
    },
    {
      caption: '鶴橋の焼肉。ホルモンの鮮度が段違いで、タレより塩で食べたくなる。市場のすぐ横、煙がすごい店。値段も驚くほど安い。大阪で焼肉といえばここに戻ってきてしまう',
      rating: 5,
      genre: '焼肉',
      price_range: '¥3,001〜¥5,000',
      location_name: 'ホルモン 松原',
      location_lat: 34.6661,
      location_lng: 135.5301,
      prefecture: '大阪府',
      area: '鶴橋',
      situations: ['飲み会', '家族で'],
      hashtags: ['焼肉', 'ホルモン', '鶴橋', '大阪'],
      images: ['https://images.unsplash.com/photo-1594041680534-e8c8cdebd659?w=800&q=90'],
      daysAgo: 14,
    },
    {
      caption: '北新地の割烹。カウンター越しに一品ずつ出てくる構成で、椀物がとにかく良かった。足すのではなく引く料理。接待で使ったが、次は一人で来たい',
      rating: 5,
      genre: '和食',
      price_range: '¥10,001〜',
      location_name: '割烹 みなも',
      location_lat: 34.6962,
      location_lng: 135.4982,
      prefecture: '大阪府',
      area: '北新地',
      situations: ['仕事で', '記念日'],
      hashtags: ['割烹', '北新地', '大阪', '椀物'],
      images: ['https://images.unsplash.com/photo-1607301405345-41e34312ba64?w=800&q=90'],
      daysAgo: 18,
    },
    {
      caption: '梅田の地下、老舗の喫茶店。ミックスジュースとホットサンドという組み合わせが完成されている。朝から開いていて、新幹線の前に必ず寄る。時間が止まっている店',
      rating: 4,
      genre: 'カフェ',
      price_range: '〜¥1,000',
      location_name: '喫茶 あかつき',
      location_lat: 34.7016,
      location_lng: 135.4972,
      prefecture: '大阪府',
      area: '梅田',
      situations: ['一人ランチにおすすめ'],
      hashtags: ['喫茶店', '梅田', '大阪', 'ミックスジュース'],
